...
```python
from sensor import available_presets
...
```python
from sensor import Session, HTTPCloakError
...
# Simple GET
response = sensor.get("https://example.com")
print(response.text)
...
# POST
response = sensor.post("https://api.example.com", data={"key": "value"})
```
