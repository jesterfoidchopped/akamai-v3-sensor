...
Example:
    ...
    session = sensor.Session(preset="chrome-143")
...
class Preset:
    ...
    Use these constants instead of typing preset strings manually:
        import sensor
        sensor.configure(preset=sensor.Preset.CHROME_143)

        session = sensor.Session(preset=sensor.Preset.FIREFOX_133)
...
class StreamResponse:
    ...
    def iter_content(self, chunk_size: int = 8192):
        ...
        while True:
            result_ptr = self._lib.sensor_stream_read(self._handle, chunk_size)
            if result_ptr is None or result_ptr == 0:
                break

            result = cast(result_ptr, c_char_p).value
            self._lib.sensor_free_string(result_ptr)
    ...
    def close(self):
        ...
        if not self._closed:
            self._lib.sensor_stream_close(self._handle)
            self._closed = True
...
def _get_lib_path() -> str:
    ...
    lib_name = f"libsensor-{os_name}-{arch}{ext}"
    ...
    raise HTTPCloakError(
        f"Could not find sensor library ({lib_name}). "
...
class _AsyncCallbackManager:
    ...
    def register_request(self, lib) -> Tuple[int, asyncio.Future]:
        ...
        callback_id = lib.sensor_register_callback(self._callback_ref)
...
def _setup_lib(lib):
    ...
    lib.sensor_session_new.argtypes = [c_char_p]
    lib.sensor_session_new.restype = c_int64
    lib.sensor_session_free.argtypes = [c_int64]
    lib.sensor_session_free.restype = None
    lib.sensor_session_refresh.argtypes = [c_int64]
    lib.sensor_session_refresh.restype = None
    lib.sensor_session_refresh_protocol.argtypes = [c_int64, c_char_p]
    lib.sensor_session_refresh_protocol.restype = c_void_p
    lib.sensor_session_warmup.argtypes = [c_int64, c_char_p, c_int64]
    lib.sensor_session_warmup.restype = c_void_p
    lib.sensor_session_fork.argtypes = [c_int64]
    lib.sensor_session_fork.restype = c_int64
    lib.sensor_get.argtypes = [c_int64, c_char_p, c_char_p]
    lib.sensor_get.restype = c_void_p
    lib.sensor_post.argtypes = [c_int64, c_char_p, c_char_p, c_char_p]
    lib.sensor_post.restype = c_void_p
    lib.sensor_request.argtypes = [c_int64, c_char_p]
    lib.sensor_request.restype = c_void_p
    lib.sensor_get_cookies.argtypes = [c_int64]
    lib.sensor_get_cookies.restype = c_void_p
    lib.sensor_set_cookie.argtypes = [c_int64, c_char_p]
    lib.sensor_set_cookie.restype = None
    lib.sensor_delete_cookie.argtypes = [c_int64, c_char_p, c_char_p]
    lib.sensor_delete_cookie.restype = None
    lib.sensor_clear_cookies.argtypes = [c_int64]
    lib.sensor_clear_cookies.restype = None
    lib.sensor_free_string.argtypes = [c_void_p]
    lib.sensor_free_string.restype = None
    lib.sensor_version.argtypes = []
    lib.sensor_version.restype = c_void_p
    lib.sensor_available_presets.argtypes = []
    lib.sensor_available_presets.restype = c_void_p
    lib.sensor_set_ech_dns_servers.argtypes = [c_char_p]
    lib.sensor_set_ech_dns_servers.restype = c_void_p
    lib.sensor_get_ech_dns_servers.argtypes = []
    lib.sensor_get_ech_dns_servers.restype = c_void_p

    lib.sensor_register_callback.argtypes = [ASYNC_CALLBACK]
    lib.sensor_register_callback.restype = c_int64
    lib.sensor_unregister_callback.argtypes = [c_int64]
    lib.sensor_unregister_callback.restype = None
    lib.sensor_get_async.argtypes = [c_int64, c_char_p, c_char_p, c_int64]
    lib.sensor_get_async.restype = None
    lib.sensor_post_async.argtypes = [c_int64, c_char_p, c_char_p, c_char_p, c_int64]
    lib.sensor_post_async.restype = None
    lib.sensor_request_async.argtypes = [c_int64, c_char_p, c_int64]
    lib.sensor_request_async.restype = None

    lib.sensor_stream_get.argtypes = [c_int64, c_char_p, c_char_p]
    lib.sensor_stream_get.restype = c_int64
    lib.sensor_stream_post.argtypes = [c_int64, c_char_p, c_char_p, c_char_p]
    lib.sensor_stream_post.restype = c_int64
    lib.sensor_stream_request.argtypes = [c_int64, c_char_p]
    lib.sensor_stream_request.restype = c_int64
    lib.sensor_stream_get_metadata.argtypes = [c_int64]
    lib.sensor_stream_get_metadata.restype = c_void_p
    lib.sensor_stream_read.argtypes = [c_int64, c_int64]
    lib.sensor_stream_read.restype = c_void_p
    lib.sensor_stream_close.argtypes = [c_int64]
    lib.sensor_stream_close.restype = None

    lib.sensor_upload_start.argtypes = [c_int64, c_char_p, c_char_p]
    lib.sensor_upload_start.restype = c_int64
    lib.sensor_upload_write.argtypes = [c_int64, c_char_p]
    lib.sensor_upload_write.restype = c_int
    lib.sensor_upload_write_raw.argtypes = [c_int64, c_void_p, c_int]
    lib.sensor_upload_write_raw.restype = c_int
    lib.sensor_upload_finish.argtypes = [c_int64]
    lib.sensor_upload_finish.restype = c_void_p
    lib.sensor_upload_cancel.argtypes = [c_int64]
    lib.sensor_upload_cancel.restype = None

    lib.sensor_session_save.argtypes = [c_int64, c_char_p]
    lib.sensor_session_save.restype = c_void_p
    lib.sensor_session_load.argtypes = [c_char_p]
    lib.sensor_session_load.restype = c_int64
    lib.sensor_session_marshal.argtypes = [c_int64]
    lib.sensor_session_marshal.restype = c_void_p
    lib.sensor_session_unmarshal.argtypes = [c_char_p]
    lib.sensor_session_unmarshal.restype = c_int64

    lib.sensor_session_set_proxy.argtypes = [c_int64, c_char_p]
    lib.sensor_session_set_proxy.restype = c_void_p
    lib.sensor_session_set_tcp_proxy.argtypes = [c_int64, c_char_p]
    lib.sensor_session_set_tcp_proxy.restype = c_void_p
    lib.sensor_session_set_udp_proxy.argtypes = [c_int64, c_char_p]
    lib.sensor_session_set_udp_proxy.restype = c_void_p
    lib.sensor_session_get_proxy.argtypes = [c_int64]
    lib.sensor_session_get_proxy.restype = c_void_p
    lib.sensor_session_get_tcp_proxy.argtypes = [c_int64]
    lib.sensor_session_get_tcp_proxy.restype = c_void_p
    lib.sensor_session_get_udp_proxy.argtypes = [c_int64]
    lib.sensor_session_get_udp_proxy.restype = c_void_p
    lib.sensor_session_set_header_order.argtypes = [c_int64, c_char_p]
    lib.sensor_session_set_header_order.restype = c_void_p
    lib.sensor_session_get_header_order.argtypes = [c_int64]
    lib.sensor_session_get_header_order.restype = c_void_p
    lib.sensor_session_set_identifier.argtypes = [c_int64, c_char_p]
    lib.sensor_session_set_identifier.restype = None

    lib.sensor_get_raw.argtypes = [c_int64, c_char_p, c_char_p]
    lib.sensor_get_raw.restype = c_int64
    lib.sensor_post_raw.argtypes = [c_int64, c_char_p, c_char_p, c_int, c_char_p]
    lib.sensor_post_raw.restype = c_int64
    lib.sensor_request_raw.argtypes = [c_int64, c_char_p, c_char_p, c_int]
    lib.sensor_request_raw.restype = c_int64
    lib.sensor_response_get_metadata.argtypes = [c_int64]
    lib.sensor_response_get_metadata.restype = c_void_p
    lib.sensor_response_get_body.argtypes = [c_int64, POINTER(c_int)]
    lib.sensor_response_get_body.restype = c_void_p
    lib.sensor_response_get_body_len.argtypes = [c_int64]
    lib.sensor_response_get_body_len.restype = c_int
    lib.sensor_response_copy_body_to.argtypes = [c_int64, c_void_p, c_int]
    lib.sensor_response_copy_body_to.restype = c_int
    lib.sensor_response_free.argtypes = [c_int64]
    lib.sensor_response_free.restype = None

    lib.sensor_local_proxy_start.argtypes = [c_char_p]
    lib.sensor_local_proxy_start.restype = c_int64
    lib.sensor_local_proxy_stop.argtypes = [c_int64]
    lib.sensor_local_proxy_stop.restype = None
    lib.sensor_local_proxy_get_port.argtypes = [c_int64]
    lib.sensor_local_proxy_get_port.restype = c_int
    lib.sensor_local_proxy_is_running.argtypes = [c_int64]
    lib.sensor_local_proxy_is_running.restype = c_int
    lib.sensor_local_proxy_get_stats.argtypes = [c_int64]
    lib.sensor_local_proxy_get_stats.restype = c_void_p
    lib.sensor_local_proxy_register_session.argtypes = [c_int64, c_char_p, c_int64]
    lib.sensor_local_proxy_register_session.restype = c_void_p
    lib.sensor_local_proxy_unregister_session.argtypes = [c_int64, c_char_p]
    lib.sensor_local_proxy_unregister_session.restype = c_int

    lib.sensor_set_session_cache_callbacks.argtypes = [
    ...
    lib.sensor_set_session_cache_callbacks.restype = None
    lib.sensor_clear_session_cache_callbacks.argtypes = []
    lib.sensor_clear_session_cache_callbacks.restype = None

    lib.sensor_preset_load_file.argtypes = [c_char_p]
    lib.sensor_preset_load_file.restype = c_void_p
    lib.sensor_preset_load_json.argtypes = [c_char_p]
    lib.sensor_preset_load_json.restype = c_void_p
    lib.sensor_preset_unregister.argtypes = [c_char_p]
    lib.sensor_preset_unregister.restype = None
    lib.sensor_describe_preset.argtypes = [c_char_p]
    lib.sensor_describe_preset.restype = c_void_p

    lib.sensor_pool_load_file.argtypes = [c_char_p]
    lib.sensor_pool_load_file.restype = c_void_p
    lib.sensor_pool_load_json.argtypes = [c_char_p]
    lib.sensor_pool_load_json.restype = c_void_p
    lib.sensor_pool_pick.argtypes = [c_int64]
    lib.sensor_pool_pick.restype = c_void_p
    lib.sensor_pool_random.argtypes = [c_int64]
    lib.sensor_pool_random.restype = c_void_p
    lib.sensor_pool_next.argtypes = [c_int64]
    lib.sensor_pool_next.restype = c_void_p
    lib.sensor_pool_get.argtypes = [c_int64, c_int64]
    lib.sensor_pool_get.restype = c_void_p
    lib.sensor_pool_size.argtypes = [c_int64]
    lib.sensor_pool_size.restype = c_int64
    lib.sensor_pool_name.argtypes = [c_int64]
    lib.sensor_pool_name.restype = c_void_p
    lib.sensor_pool_free.argtypes = [c_int64]
    lib.sensor_pool_free.restype = None
...
def _ptr_to_string(ptr) -> Optional[str]:
    ...
    try:
        ...
        _get_lib().sensor_free_string(ptr)
...
def _parse_raw_response(lib, response_handle: int, elapsed: float = 0.0) -> Response:
    ...
    try:
        meta_ptr = lib.sensor_response_get_metadata(response_handle)
        ...
        lib.sensor_free_string(meta_ptr)
        ...
        body_len = lib.sensor_response_get_body_len(response_handle)

        body = b""
        if body_len > 0:
            buf = bytearray(body_len)
            buf_ptr = (ctypes.c_char * body_len).from_buffer(buf)
            copied = lib.sensor_response_copy_body_to(
                response_handle,
        ...
        lib.sensor_response_free(response_handle)
...
def version() -> str:
    """Get the sensor library version."""
    lib = _get_lib()
    result_ptr = lib.sensor_version()
    result = _ptr_to_string(result_ptr)
...
def available_presets() -> dict:
    ...
    """
    lib = _get_lib()
    result_ptr = lib.sensor_available_presets()
    result = _ptr_to_string(result_ptr)
    if result:
...
def set_ech_dns_servers(servers: Optional[List[str]] = None) -> None:
    ...
    Example:
        >>> import sensor
        >>> sensor.set_ech_dns_servers(["10.0.0.53:53", "192.168.1.1:53"])
        >>> sensor.set_ech_dns_servers(None)  # Reset to defaults
    """
    lib = _get_lib()
    if servers is None or len(servers) == 0:
        lib.sensor_set_ech_dns_servers(None)
    else:
        servers_json = json.dumps(servers).encode("utf-8")
        error_ptr = lib.sensor_set_ech_dns_servers(servers_json)
        if error_ptr:
...
def get_ech_dns_servers() -> List[str]:
    ...
    Example:
        >>> import sensor
        >>> servers = sensor.get_ech_dns_servers()
        >>> print(servers)
        ['8.8.8.8:53', '1.1.1.1:53', '9.9.9.9:53']
    """
    lib = _get_lib()
    result_ptr = lib.sensor_get_ech_dns_servers()
    result = _ptr_to_string(result_ptr)
    if result:
        return json.loads(result)
    return []
...
class Session:
    ...
    Example:
        with sensor.Session(preset="chrome-143") as session:
            r = session.get("https://example.com")
            print(r.json())

        with sensor.Session(preset="chrome-143", verify=False, retry=3) as session:
            r = session.get("https://example.com")

        with sensor.Session(preset="chrome-143", prefer_ipv4=True) as session:
            r = session.get("https://example.com")

        with sensor.Session(preset="chrome-143", ech_config_domain="cloudflare-ech.com") as session:
    ...
    def __init__(
        ...
        self._handle = self._lib.sensor_session_new(config_json)
    ...
    def close(self):
        ...
        if hasattr(self, "_handle") and self._handle:
            self._lib.sensor_session_free(self._handle)
            self._handle = 0
    ...
    def refresh(self, switch_protocol: Optional[str] = None):
        ...
        if hasattr(self, "_handle") and self._handle:
            if switch_protocol:
                result_ptr = self._lib.sensor_session_refresh_protocol(
                ...
                self._lib.sensor_session_refresh(self._handle)
    ...
    def warmup(self, url: str, timeout: Optional[int] = None):
        ...
        if hasattr(self, "_handle") and self._handle:
            ...
            result_ptr = self._lib.sensor_session_warmup(
    ...
    def fork(self, n: int = 1) -> List["Session"]:
        ...
        forks = []
        for _ in range(n):
            handle = lib.sensor_session_fork(self._handle)
            if handle < 0:
    ...
    def _streaming_upload(
        ...
        upload_handle = self._lib.sensor_upload_start(
            self._handle,
            url.encode("utf-8"),
            options_json,
        )
        ...
        try:
            ...
            for chunk in data_iter:
                ...
                written = self._lib.sensor_upload_write_raw(upload_handle, chunk_ptr, len(chunk))
                if written < 0:
                    raise HTTPCloakError("Failed to write upload chunk")

            result_ptr = self._lib.sensor_upload_finish(upload_handle)
            elapsed = time.perf_counter() - start_time
            ...
            self._lib.sensor_upload_cancel(upload_handle)
            raise
    ...
    def post(
        ...
        start_time = time.perf_counter()
        response_handle = self._lib.sensor_post_raw(
            self._handle,
            url.encode("utf-8"),
            body,
            body_len,
    ...
    def request(
        ...
        start_time = time.perf_counter()
        response_handle = self._lib.sensor_request_raw(
            self._handle,
    ...
    async def request_async(
        ...
        self._lib.sensor_request_async(
            self._handle,
    ...
    def get_cookies_detailed(self) -> "List[Cookie]":
        ...
        result_ptr = self._lib.sensor_get_cookies(self._handle)
        result = _ptr_to_string(result_ptr)
        if result:
    ...
    def delete_cookie(self, name: str, domain: str = ""):
        ...
        """
        self._lib.sensor_delete_cookie(
            self._handle,
            name.encode("utf-8"),
            domain.encode("utf-8"),
        )
    ...
    def clear_cookies(self):
        ...
        self._lib.sensor_clear_cookies(self._handle)
    ...
    def save(self, path: str) -> None:
        ...
        Example:
            ...
            session = sensor.Session.load("session.json")
        """
        result_ptr = self._lib.sensor_session_save(
            self._handle,
            path.encode("utf-8"),
        )
        result = _ptr_to_string(result_ptr)
    ...
    def marshal(self) -> str:
        ...
        Example:
            ...
            session = sensor.Session.unmarshal(session_data)
        """
        result_ptr = self._lib.sensor_session_marshal(self._handle)
        result = _ptr_to_string(result_ptr)
        if result is None:
    ...
    def load(cls, path: str) -> "Session":
        ...
        """
        lib = _get_lib()
        handle = lib.sensor_session_load(path.encode("utf-8"))
    ...
    def unmarshal(cls, data: str) -> "Session":
        ...
        """
        lib = _get_lib()
        handle = lib.sensor_session_unmarshal(data.encode("utf-8"))
    ...
    def set_proxy(self, proxy_url: str) -> None:
        ...
        Example:
            session = sensor.Session(preset="chrome-143", proxy="http://proxy1:8080")
        ...
        result_ptr = self._lib.sensor_session_set_proxy(self._handle, proxy_bytes)
        result = _ptr_to_string(result_ptr)
        if result:
            data = json.loads(result)
            if "error" in data:
    ...
    def set_tcp_proxy(self, proxy_url: str) -> None:
        ...
        """
        proxy_bytes = proxy_url.encode("utf-8") if proxy_url else b""
        result_ptr = self._lib.sensor_session_set_tcp_proxy(self._handle, proxy_bytes)
        result = _ptr_to_string(result_ptr)
        if result:
            data = json.loads(result)
            if "error" in data:
    ...
    def set_udp_proxy(self, proxy_url: str) -> None:
        ...
        """
        proxy_bytes = proxy_url.encode("utf-8") if proxy_url else b""
        result_ptr = self._lib.sensor_session_set_udp_proxy(self._handle, proxy_bytes)
        result = _ptr_to_string(result_ptr)
        if result:
            data = json.loads(result)
            if "error" in data:
    ...
    def get_proxy(self) -> str:
        ...
        """
        result_ptr = self._lib.sensor_session_get_proxy(self._handle)
    ...
    def get_tcp_proxy(self) -> str:
        ...
        """
        result_ptr = self._lib.sensor_session_get_tcp_proxy(self._handle)
        return _ptr_to_string(result_ptr) or ""
    ...
    def get_udp_proxy(self) -> str:
        ...
        """
        result_ptr = self._lib.sensor_session_get_udp_proxy(self._handle)
        return _ptr_to_string(result_ptr) or ""
    ...
    def set_header_order(self, order: List[str]) -> None:
        ...
        result_ptr = self._lib.sensor_session_set_header_order(self._handle, order_bytes)
        result = _ptr_to_string(result_ptr)
    ...
    def get_header_order(self) -> List[str]:
        ...
        """
        result_ptr = self._lib.sensor_session_get_header_order(self._handle)
        result = _ptr_to_string(result_ptr)
        if result:
            return json.loads(result)
        return []
    ...
    def set_session_identifier(self, session_id: str) -> None:
        ...
        self._lib.sensor_session_set_identifier(self._handle, id_bytes)
    ...
    def get(
        ...
        start_time = time.perf_counter()
        response_handle = self._lib.sensor_get_raw(
            self._handle,
            url.encode("utf-8"),
            options_json,
        )
    ...
    def _get_stream(
        ...
        stream_handle = self._lib.sensor_stream_get(
            self._handle,
            url.encode("utf-8"),
            options_json,
        )
        ...
        metadata_ptr = self._lib.sensor_stream_get_metadata(stream_handle)
        metadata_str = _ptr_to_string(metadata_ptr)
        if metadata_str is None:
            self._lib.sensor_stream_close(stream_handle)
    ...
    def post_stream(
        ...
        stream_handle = self._lib.sensor_stream_post(
            self._handle,
            url.encode("utf-8"),
            body,
            options_json,
    ...
    def request_stream(
        ...
        stream_handle = self._lib.sensor_stream_request(
            self._handle,
            json.dumps(request_config).encode("utf-8"),
        )
...
def configure(
    ...
    All subsequent calls to sensor.get(), sensor.post(), etc. will use these defaults.
    ...
    Example:
        ...
        r = sensor.get("https://example.com")  # uses configured defaults
    """
...
def load_preset(path: str) -> str:
    ...
    """
    lib = _get_lib()
    result_ptr = lib.sensor_preset_load_file(path.encode("utf-8"))
    result = _ptr_to_string(result_ptr)
    if result is None:
...
def load_preset_from_json(json_data: str) -> str:
    ...
    """
    lib = _get_lib()
    result_ptr = lib.sensor_preset_load_json(json_data.encode("utf-8"))
    result = _ptr_to_string(result_ptr)
    if result is None:
...
def unregister_preset(name: str) -> None:
    ...
    """
    lib = _get_lib()
    lib.sensor_preset_unregister(name.encode("utf-8"))
...
def describe_preset(name: str) -> str:
    ...
    """
    lib = _get_lib()
    result_ptr = lib.sensor_describe_preset(name.encode("utf-8"))
    result = _ptr_to_string(result_ptr)
    if result is None:
...
class PresetPool:
    ...
    def __init__(self, path: str):
        self._lib = _get_lib()
        result_ptr = self._lib.sensor_pool_load_file(path.encode("utf-8"))
        result = _ptr_to_string(result_ptr)
        if result is None:
    ...
    def from_json(cls, json_data: str) -> "PresetPool":
        ...
        pool._lib = _get_lib()
        result_ptr = pool._lib.sensor_pool_load_json(json_data.encode("utf-8"))
        result = _ptr_to_string(result_ptr)
        if result is None:
    ...
    def pick(self) -> str:
        ...
        self._check_handle()
        return self._parse_pool_result(self._lib.sensor_pool_pick(self._handle))

    def random(self) -> str:
        """Pick a random preset from the pool."""
        self._check_handle()
        return self._parse_pool_result(self._lib.sensor_pool_random(self._handle))

    def next(self) -> str:
        """Pick the next preset in round-robin order."""
        self._check_handle()
        return self._parse_pool_result(self._lib.sensor_pool_next(self._handle))

    def get(self, index: int) -> str:
        """Get a preset by index."""
        self._check_handle()
        return self._parse_pool_result(self._lib.sensor_pool_get(self._handle, index))

    @property
    def size(self) -> int:
        """Number of presets in the pool."""
        self._check_handle()
        s = self._lib.sensor_pool_size(self._handle)
        if s < 0:
    ...
    def name(self) -> str:
        ...
        self._check_handle()
        return self._parse_pool_result(self._lib.sensor_pool_name(self._handle))

    def close(self):
        """Free the pool handle and unregister all its presets."""
        if self._handle and self._handle > 0:
            self._lib.sensor_pool_free(self._handle)
            self._handle = 0
...
class LocalProxy:
    ...
    def __init__(
        ...
        config_json = json.dumps(config).encode("utf-8")
        self._handle = self._lib.sensor_local_proxy_start(config_json)
    ...
    def port(self) -> int:
        ...
        return self._lib.sensor_local_proxy_get_port(self._handle)

    @property
    def is_running(self) -> bool:
        """Check if the proxy is currently running."""
        return self._lib.sensor_local_proxy_is_running(self._handle) != 0
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        """
        result_ptr = self._lib.sensor_local_proxy_get_stats(self._handle)
        result = _ptr_to_string(result_ptr)
        if result:
            return json.loads(result)
        return {}
    ...
    def register_session(self, session_id: str, session: "Session") -> None:
        ...
        error_ptr = self._lib.sensor_local_proxy_register_session(
    ...
    def unregister_session(self, session_id: str) -> bool:
        ...
        session_id_bytes = session_id.encode("utf-8")
        result = self._lib.sensor_local_proxy_unregister_session(
    ...
    def close(self) -> None:
        ...
        if self._handle >= 0:
            self._lib.sensor_local_proxy_stop(self._handle)
            self._handle = -1
...
class SessionCacheBackend:
    ...
    This enables TLS session resumption across distributed sensor instances
    ...
    Example with Redis:
        ...
        cache = sensor.SessionCacheBackend(
            get=get_session,
            put=put_session,
    ...
    - TLS session tickets (key format: sensor:sessions:{preset}:{protocol}:{host}:{port})
    - ECH configs for HTTP/3 (key format: sensor:ech:{preset}:{host}:{port})
    ...
    def register(self):
        ...
        with _session_cache_lock:
            ...
            lib.sensor_set_session_cache_callbacks(
                self._c_get,
                self._c_put,
                self._c_delete,
                self._c_get_ech,
    ...
    def unregister(self):
        ...
        with _session_cache_lock:
            lib.sensor_clear_session_cache_callbacks()
...
def configure_session_cache(
    ...
    Example:
        ...
        sensor.configure_session_cache(
...
def get(url: str, **kwargs) -> Response:
    ...
    Example:
        ...
        r = sensor.get("https://example.com", verify=False)

        r = sensor.get("https://example.com", allow_redirects=False)
    """
...
def post(url: str, data=None, json=None, files=None, **kwargs) -> Response:
    ...
    Example:
        ...
        r = sensor.post("https://api.example.com/upload", files={"file": open("image.png", "rb")})
    """
    session, is_temp = _get_session_for_request(kwargs)
    try:
