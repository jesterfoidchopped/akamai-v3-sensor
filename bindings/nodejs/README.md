...
```javascript
const { availablePresets } = require("sensor");
...
```javascript
const { Session, HTTPCloakError } = require("sensor");
...
```typescript
import { Session, Response, StreamResponse, HTTPCloakError } from "sensor";
