...
export interface RequestOptions {
   ...
   *
   * When unset (default), sensor auto-detects based on method, Accept, Content-Type, and Sec-Fetch-Dest headers.
 ...
 *
 * Enables TLS session resumption across distributed sensor instances
 ...
 *
 * Cache key formats:
 * - TLS sessions: sensor:sessions:{preset}:{protocol}:{host}:{port}
 * - ECH configs: sensor:ech:{preset}:{host}:{port}
 *
 * @example
