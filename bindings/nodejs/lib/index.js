 ...
 *
 *   // Or with Session
 *   const session = new sensor.Session({ preset: sensor.Preset.FIREFOX_133 });
 */
const Preset = {
...
class StreamResponse {
  ...
  readChunk(chunkSize = 8192) {
    ...
    const result = this._lib.sensor_stream_read(this._handle, chunkSize);
    if (!result || result === "") {
      return null; // EOF
    }
  ...
  close() {
    if (!this._closed) {
      this._lib.sensor_stream_close(this._handle);
      this._closed = true;
    }
  }
...
function getPlatformPackageName() {
  ...
  return `@sensor/${platName}-${archName}`;
}
...
function getLibPath() {
  ...
  const libName = `libsensor-${osName}-${archName}${ext}`;
  ...
  throw new HTTPCloakError(
    `Could not find sensor library (${libName}). ` +
...
function getLib() {
  if (lib === null) {
    ...
    const sensorFreeString = nativeLibHandle.func("sensor_free_string", "void", ["void*"]);

    const HeapStr = koffi.disposable("HeapStr", "str", sensorFreeString);

    lib = {
      sensor_session_new: nativeLibHandle.func("sensor_session_new", "int64", ["str"]),
      sensor_session_free: nativeLibHandle.func("sensor_session_free", "void", ["int64"]),
      sensor_session_refresh: nativeLibHandle.func("sensor_session_refresh", "void", ["int64"]),
      sensor_session_refresh_protocol: nativeLibHandle.func("sensor_session_refresh_protocol", HeapStr, ["int64", "str"]),
      sensor_session_warmup: nativeLibHandle.func("sensor_session_warmup", HeapStr, ["int64", "str", "int64"]),
      sensor_session_fork: nativeLibHandle.func("sensor_session_fork", "int64", ["int64"]),
      sensor_get: nativeLibHandle.func("sensor_get", HeapStr, ["int64", "str", "str"]),
      sensor_post: nativeLibHandle.func("sensor_post", HeapStr, ["int64", "str", "str", "str"]),
      sensor_request: nativeLibHandle.func("sensor_request", HeapStr, ["int64", "str"]),
      sensor_get_cookies: nativeLibHandle.func("sensor_get_cookies", HeapStr, ["int64"]),
      sensor_set_cookie: nativeLibHandle.func("sensor_set_cookie", "void", ["int64", "str"]),
      sensor_delete_cookie: nativeLibHandle.func("sensor_delete_cookie", "void", ["int64", "str", "str"]),
      sensor_clear_cookies: nativeLibHandle.func("sensor_clear_cookies", "void", ["int64"]),
      sensor_free_string: sensorFreeString,
      sensor_version: nativeLibHandle.func("sensor_version", HeapStr, []),
      sensor_available_presets: nativeLibHandle.func("sensor_available_presets", HeapStr, []),
      sensor_set_ech_dns_servers: nativeLibHandle.func("sensor_set_ech_dns_servers", HeapStr, ["str"]),
      sensor_get_ech_dns_servers: nativeLibHandle.func("sensor_get_ech_dns_servers", HeapStr, []),
      sensor_register_callback: nativeLibHandle.func("sensor_register_callback", "int64", [koffi.pointer(AsyncCallbackProto)]),
      sensor_unregister_callback: nativeLibHandle.func("sensor_unregister_callback", "void", ["int64"]),
      sensor_get_async: nativeLibHandle.func("sensor_get_async", "void", ["int64", "str", "str", "int64"]),
      sensor_post_async: nativeLibHandle.func("sensor_post_async", "void", ["int64", "str", "str", "str", "int64"]),
      sensor_request_async: nativeLibHandle.func("sensor_request_async", "void", ["int64", "str", "int64"]),
      sensor_stream_get: nativeLibHandle.func("sensor_stream_get", "int64", ["int64", "str", "str"]),
      sensor_stream_post: nativeLibHandle.func("sensor_stream_post", "int64", ["int64", "str", "str", "str"]),
      sensor_stream_request: nativeLibHandle.func("sensor_stream_request", "int64", ["int64", "str"]),
      sensor_stream_get_metadata: nativeLibHandle.func("sensor_stream_get_metadata", HeapStr, ["int64"]),
      sensor_stream_read: nativeLibHandle.func("sensor_stream_read", HeapStr, ["int64", "int64"]),
      sensor_stream_close: nativeLibHandle.func("sensor_stream_close", "void", ["int64"]),
      sensor_get_raw: nativeLibHandle.func("sensor_get_raw", "int64", ["int64", "str", "str"]),
      sensor_post_raw: nativeLibHandle.func("sensor_post_raw", "int64", ["int64", "str", "void*", "int", "str"]),
      sensor_request_raw: nativeLibHandle.func("sensor_request_raw", "int64", ["int64", "str", "void*", "int"]),
      sensor_response_get_metadata: nativeLibHandle.func("sensor_response_get_metadata", HeapStr, ["int64"]),
      sensor_response_get_body_len: nativeLibHandle.func("sensor_response_get_body_len", "int", ["int64"]),
      sensor_response_copy_body_to: nativeLibHandle.func("sensor_response_copy_body_to", "int", ["int64", "void*", "int"]),
      sensor_response_free: nativeLibHandle.func("sensor_response_free", "void", ["int64"]),
      sensor_response_finalize: nativeLibHandle.func("sensor_response_finalize", HeapStr, ["int64", "void*", "int"]),
      sensor_session_save: nativeLibHandle.func("sensor_session_save", HeapStr, ["int64", "str"]),
      sensor_session_load: nativeLibHandle.func("sensor_session_load", "int64", ["str"]),
      sensor_session_marshal: nativeLibHandle.func("sensor_session_marshal", HeapStr, ["int64"]),
      sensor_session_unmarshal: nativeLibHandle.func("sensor_session_unmarshal", "int64", ["str"]),
      sensor_session_set_proxy: nativeLibHandle.func("sensor_session_set_proxy", HeapStr, ["int64", "str"]),
      sensor_session_set_tcp_proxy: nativeLibHandle.func("sensor_session_set_tcp_proxy", HeapStr, ["int64", "str"]),
      sensor_session_set_udp_proxy: nativeLibHandle.func("sensor_session_set_udp_proxy", HeapStr, ["int64", "str"]),
      sensor_session_get_proxy: nativeLibHandle.func("sensor_session_get_proxy", HeapStr, ["int64"]),
      sensor_session_get_tcp_proxy: nativeLibHandle.func("sensor_session_get_tcp_proxy", HeapStr, ["int64"]),
      sensor_session_get_udp_proxy: nativeLibHandle.func("sensor_session_get_udp_proxy", HeapStr, ["int64"]),
      sensor_session_set_header_order: nativeLibHandle.func("sensor_session_set_header_order", HeapStr, ["int64", "str"]),
      sensor_session_get_header_order: nativeLibHandle.func("sensor_session_get_header_order", HeapStr, ["int64"]),
      sensor_local_proxy_start: nativeLibHandle.func("sensor_local_proxy_start", "int64", ["str"]),
      sensor_local_proxy_stop: nativeLibHandle.func("sensor_local_proxy_stop", "void", ["int64"]),
      sensor_local_proxy_get_port: nativeLibHandle.func("sensor_local_proxy_get_port", "int", ["int64"]),
      sensor_local_proxy_is_running: nativeLibHandle.func("sensor_local_proxy_is_running", "int", ["int64"]),
      sensor_local_proxy_get_stats: nativeLibHandle.func("sensor_local_proxy_get_stats", HeapStr, ["int64"]),
      sensor_local_proxy_register_session: nativeLibHandle.func("sensor_local_proxy_register_session", HeapStr, ["int64", "str", "int64"]),
      sensor_local_proxy_unregister_session: nativeLibHandle.func("sensor_local_proxy_unregister_session", "int", ["int64", "str"]),
      sensor_set_session_cache_callbacks: nativeLibHandle.func("sensor_set_session_cache_callbacks", "void", [
      ...
      sensor_clear_session_cache_callbacks: nativeLibHandle.func("sensor_clear_session_cache_callbacks", "void", []),
      sensor_set_async_session_cache_callbacks: nativeLibHandle.func("sensor_set_async_session_cache_callbacks", "void", [
      ...
      sensor_async_cache_get_result: nativeLibHandle.func("sensor_async_cache_get_result", "void", ["int64", "str"]),
      sensor_async_cache_op_result: nativeLibHandle.func("sensor_async_cache_op_result", "void", ["int64", "int"]),
      sensor_preset_load_file: nativeLibHandle.func("sensor_preset_load_file", "void*", ["str"]),
      sensor_preset_load_json: nativeLibHandle.func("sensor_preset_load_json", "void*", ["str"]),
      sensor_preset_unregister: nativeLibHandle.func("sensor_preset_unregister", "void", ["str"]),
      sensor_describe_preset: nativeLibHandle.func("sensor_describe_preset", HeapStr, ["str"]),
      sensor_pool_load_file: nativeLibHandle.func("sensor_pool_load_file", "void*", ["str"]),
      sensor_pool_load_json: nativeLibHandle.func("sensor_pool_load_json", "void*", ["str"]),
      sensor_pool_pick: nativeLibHandle.func("sensor_pool_pick", "void*", ["int64"]),
      sensor_pool_random: nativeLibHandle.func("sensor_pool_random", "void*", ["int64"]),
      sensor_pool_next: nativeLibHandle.func("sensor_pool_next", "void*", ["int64"]),
      sensor_pool_get: nativeLibHandle.func("sensor_pool_get", "void*", ["int64", "int64"]),
      sensor_pool_size: nativeLibHandle.func("sensor_pool_size", "int64", ["int64"]),
      sensor_pool_name: nativeLibHandle.func("sensor_pool_name", "void*", ["int64"]),
      sensor_pool_free: nativeLibHandle.func("sensor_pool_free", "void", ["int64"]),
    };
  }
  return lib;
}
...
class AsyncCallbackManager {
  ...
  registerRequest(nativeLib) {
    ...
    const callbackId = nativeLib.sensor_register_callback(this._callbackPtr);
...
/**
 * Parse a raw response handle returned by sensor_*_raw into a Response
...
function parseRawResponse(lib, responseHandle, elapsed = 0) {
  const bodyLen = lib.sensor_response_get_body_len(responseHandle);
  if (bodyLen < 0) {
    lib.sensor_response_free(responseHandle);
    throw new HTTPCloakError("Failed to get response body length");
  }

  const buffer = Buffer.allocUnsafe(bodyLen);
  const metadataStr = lib.sensor_response_finalize(responseHandle, buffer, bodyLen);
  if (!metadataStr) {
...
function version() {
  ...
  const resultPtr = nativeLib.sensor_version();
  const result = resultToString(resultPtr);
...
function availablePresets() {
  const nativeLib = getLib();
  const resultPtr = nativeLib.sensor_available_presets();
  const result = resultToString(resultPtr);
  if (result) {
...
function setEchDnsServers(servers) {
  ...
  const errorPtr = nativeLib.sensor_set_ech_dns_servers(serversJson);
...
function getEchDnsServers() {
  const nativeLib = getLib();
  const resultPtr = nativeLib.sensor_get_ech_dns_servers();
  const result = resultToString(resultPtr);
  if (result) {
    return JSON.parse(result);
  }
...
class Session {
  ...
  constructor(options = {}) {
    ...
    this._handle = this._lib.sensor_session_new(JSON.stringify(config));
  ...
  close() {
    if (this._handle) {
      this._lib.sensor_session_free(this._handle);
      this._handle = 0n;
    }
  }
  ...
  refresh(switchProtocol) {
    if (this._handle) {
      if (switchProtocol) {
        const result = this._lib.sensor_session_refresh_protocol(this._handle, switchProtocol);
        if (result) {
          const data = JSON.parse(result);
          if (data.error) {
            throw new HTTPCloakError(data.error);
        ...
        this._lib.sensor_session_refresh(this._handle);
      }
    }
  }
  ...
  warmup(url, options = {}) {
    if (this._handle) {
      ...
      const result = this._lib.sensor_session_warmup(this._handle, url, timeoutMs);
      if (result) {
        const data = JSON.parse(result);
        if (data.error) {
          throw new HTTPCloakError(data.error);
  ...
  fork(n = 1) {
    const forks = [];
    for (let i = 0; i < n; i++) {
      const handle = this._lib.sensor_session_fork(this._handle);
  ...
  getSync(url, options = {}) {
    ...
    const startTime = Date.now();
    const responseHandle = this._lib.sensor_get_raw(this._handle, url, optionsJson);
    const elapsed = Date.now() - startTime;
  ...
  postSync(url, options = {}) {
    ...
    const startTime = Date.now();
    const responseHandle = this._lib.sensor_post_raw(this._handle, url, bodyPtr, bodyLen, optionsJson);
    const elapsed = Date.now() - startTime;
    if (responseHandle < 0 || responseHandle === 0 || responseHandle === 0n) {
      throw new HTTPCloakError("Request failed");
    }
  ...
  requestSync(method, url, options = {}) {
    ...
    const startTime = Date.now();
    const responseHandle = this._lib.sensor_request_raw(
      this._handle,
  ...
  get(url, options = {}) {
    ...
    this._lib.sensor_get_async(this._handle, url, optionsJson, callbackId);
  ...
  post(url, options = {}) {
    ...
    this._lib.sensor_post_async(this._handle, url, body, optionsJson, callbackId);
  ...
  request(method, url, options = {}) {
    ...
    this._lib.sensor_request_async(this._handle, JSON.stringify(requestConfig), callbackId);
   ...
   */
  getCookiesDetailed() {
    const resultPtr = this._lib.sensor_get_cookies(this._handle);
    const result = resultToString(resultPtr);
    if (result) {
  ...
  setCookie(name, value, options = {}) {
    ...
    this._lib.sensor_set_cookie(this._handle, JSON.stringify(cookie));
  }
  ...
  deleteCookie(name, domain = "") {
    this._lib.sensor_delete_cookie(this._handle, name, domain);
  }
   ...
   */
  clearCookies() {
    this._lib.sensor_clear_cookies(this._handle);
  }
   ...
   *
   * Example:
   *   const session = new sensor.Session({ proxy: "http://proxy1:8080" });
  ...
  setProxy(proxyUrl) {
    const url = proxyUrl || "";
    this._lib.sensor_session_set_proxy(this._handle, url);
  }
  ...
  setTcpProxy(proxyUrl) {
    const url = proxyUrl || "";
    this._lib.sensor_session_set_tcp_proxy(this._handle, url);
  }
  ...
  setUdpProxy(proxyUrl) {
    const url = proxyUrl || "";
    this._lib.sensor_session_set_udp_proxy(this._handle, url);
  }
   ...
   */
  getProxy() {
    const result = this._lib.sensor_session_get_proxy(this._handle);
    return result || "";
  }
   ...
   */
  getTcpProxy() {
    const result = this._lib.sensor_session_get_tcp_proxy(this._handle);
    return result || "";
  }
   ...
   */
  getUdpProxy() {
    const result = this._lib.sensor_session_get_udp_proxy(this._handle);
    return result || "";
  }
  ...
  setHeaderOrder(order) {
    ...
    const result = this._lib.sensor_session_set_header_order(this._handle, orderJson);
   ...
   */
  getHeaderOrder() {
    const result = this._lib.sensor_session_get_header_order(this._handle);
    if (result) {
      return JSON.parse(result);
    }
    return [];
  ...
  setSessionIdentifier(sessionId) {
    this._lib.sensor_session_set_identifier(this._handle, sessionId || null);
  }
   ...
   *
   * Example:
   *   const session = new sensor.Session({ preset: "chrome-146" });
   *   await session.get("https://example.com");  // Acquire cookies
   *   session.save("session.json");
   *
   *   // Later, restore the session
   *   const session = sensor.Session.load("session.json");
   */
  save(path) {
    const result = this._lib.sensor_session_save(this._handle, path);
    if (result) {
      const data = JSON.parse(result);
      if (data.error) {
        throw new HTTPCloakError(data.error);
   ...
   *
   *   // Later, restore the session
   *   const session = sensor.Session.unmarshal(sessionData);
   */
  marshal() {
    const result = this._lib.sensor_session_marshal(this._handle);
    if (!result) {
  ...
  static load(path) {
    const lib = getLib();
    const handle = lib.sensor_session_load(path);
  ...
  static unmarshal(data) {
    const lib = getLib();
    const handle = lib.sensor_session_unmarshal(data);
  ...
  getStream(url, options = {}) {
    ...
    const streamHandle = this._lib.sensor_stream_get(this._handle, url, optionsJson);
    if (streamHandle < 0) {
      throw new HTTPCloakError("Failed to start streaming request");
    }

    const metadataStr = this._lib.sensor_stream_get_metadata(streamHandle);
    if (!metadataStr) {
      this._lib.sensor_stream_close(streamHandle);
  ...
  postStream(url, options = {}) {
    ...
    const streamHandle = this._lib.sensor_stream_post(this._handle, url, body, optionsJson);
    if (streamHandle < 0) {
      throw new HTTPCloakError("Failed to start streaming request");
    }
  ...
  requestStream(method, url, options = {}) {
    ...
    const streamHandle = this._lib.sensor_stream_request(this._handle, JSON.stringify(requestConfig));
    if (streamHandle < 0) {
      throw new HTTPCloakError("Failed to start streaming request");
    }
  ...
  getFast(url, options = {}) {
    ...
    const bodyLen = this._lib.sensor_response_get_body_len(responseHandle);
    if (bodyLen < 0) {
      this._lib.sensor_response_free(responseHandle);
      throw new HTTPCloakError("Failed to get response body length");
    }

    const pooledBuffer = _bufferPool.acquire(bodyLen);

    const metadataStr = this._lib.sensor_response_finalize(responseHandle, pooledBuffer, bodyLen);
    if (!metadataStr) {
  ...
  postFast(url, options = {}) {
    ...
    const responseHandle = this._lib.sensor_post_raw(this._handle, url, body, body.length, optionsJson);
...
/**
 * Local HTTP proxy server that forwards requests through sensor with TLS fingerprinting.
...
class LocalProxy {
  ...
  constructor(options = {}) {
    ...
    this._handle = this._lib.sensor_local_proxy_start(configJson);
   ...
   */
  get port() {
    return this._lib.sensor_local_proxy_get_port(this._handle);
  }
   ...
   */
  get isRunning() {
    return this._lib.sensor_local_proxy_is_running(this._handle) !== 0;
  }
   ...
   */
  getStats() {
    const resultPtr = this._lib.sensor_local_proxy_get_stats(this._handle);
    const result = resultToString(resultPtr);
    if (result) {
      return JSON.parse(result);
    }
  ...
  registerSession(sessionId, session) {
    ...
    const resultPtr = this._lib.sensor_local_proxy_register_session(
      this._handle,
      sessionId,
      session._handle
    );
  ...
  unregisterSession(sessionId) {
    const result = this._lib.sensor_local_proxy_unregister_session(
      this._handle,
      sessionId
    );
    return result === 1;
  ...
  close() {
    if (this._handle >= 0) {
      this._lib.sensor_local_proxy_stop(this._handle);
      this._handle = -1;
    }
  }
}
 ...
 *
 * const cache = new sensor.SessionCacheBackend({
 ...
 * const session = new sensor.Session({ preset: 'chrome-143' });
...
class SessionCacheBackend {
  ...
  _registerAsync(lib) {
    ...
    _sessionCacheCallbackPtrs.get = koffi.register((requestId, key) => {
      if (!getFn) {
        lib.sensor_async_cache_get_result(requestId, null);
        return;
      }
      Promise.resolve()
        .then(() => getFn(key))
        .then((result) => {
          lib.sensor_async_cache_get_result(requestId, result || null);
        })
        .catch(() => {
          lib.sensor_async_cache_get_result(requestId, null);
        });
    ...
    _sessionCacheCallbackPtrs.put = koffi.register((requestId, key, value, ttlSeconds) => {
      if (!putFn) {
        lib.sensor_async_cache_op_result(requestId, 0);
        return;
      }
      Promise.resolve()
        .then(() => putFn(key, value, Number(ttlSeconds)))
        .then((result) => {
          lib.sensor_async_cache_op_result(requestId, result || 0);
        })
        .catch(() => {
          lib.sensor_async_cache_op_result(requestId, -1);
        });
    }, koffi.pointer(AsyncCachePutProto));
    ...
    lib.sensor_set_async_session_cache_callbacks(
      _sessionCacheCallbackPtrs.get,
      _sessionCacheCallbackPtrs.put,
      _sessionCacheCallbackPtrs.delete,
      _sessionCacheCallbackPtrs.getEch,
...
function loadPreset(filePath) {
  const lib = getLib();
  const result = readAndFreeString(lib.sensor_preset_load_file(filePath));
  if (!result) {
...
function loadPresetFromJSON(jsonData) {
  const lib = getLib();
  const result = readAndFreeString(lib.sensor_preset_load_json(jsonData));
  if (!result) {
...
function unregisterPreset(name) {
  const lib = getLib();
  lib.sensor_preset_unregister(name);
}
...
function describePreset(name) {
  const lib = getLib();
  const result = lib.sensor_describe_preset(name);
  if (!result) {
...
class PresetPool {
  ...
  constructor(filePath) {
    this._lib = getLib();
    const result = readAndFreeString(this._lib.sensor_pool_load_file(filePath));
    if (!result) {
  ...
  static fromJSON(jsonData) {
    ...
    pool._lib = getLib();
    const result = readAndFreeString(pool._lib.sensor_pool_load_json(jsonData));
    if (!result) {
  ...
  pick() {
    this._checkHandle();
    return this._parsePoolResult(this._lib.sensor_pool_pick(this._handle));
  }
  ...
  random() {
    this._checkHandle();
    return this._parsePoolResult(this._lib.sensor_pool_random(this._handle));
  }
  ...
  next() {
    this._checkHandle();
    return this._parsePoolResult(this._lib.sensor_pool_next(this._handle));
  }
  ...
  get(index) {
    this._checkHandle();
    return this._parsePoolResult(this._lib.sensor_pool_get(this._handle, index));
  }
  ...
  get size() {
    this._checkHandle();
    const s = this._lib.sensor_pool_size(this._handle);
    if (s < 0) {
  ...
  get name() {
    this._checkHandle();
    return this._parsePoolResult(this._lib.sensor_pool_name(this._handle));
  }
  ...
  close() {
    if (this._handle && this._handle !== 0n && this._handle !== 0) {
      this._lib.sensor_pool_free(this._handle);
      this._handle = 0n;
    }
  }
