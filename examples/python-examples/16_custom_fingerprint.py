#!/usr/bin/env python3
"""
Custom JA3 & Akamai Fingerprinting with sensor
...
with sensor.Session(preset="chrome-latest", ja3=CHROME_131_JA3) as session:
...
with sensor.Session(preset="chrome-latest", akamai=CHROME_AKAMAI) as session:
