...
async function main() {
  ...
  const session1 = new sensor.Session({ preset: "chrome-latest" });
  ...
  const session3 = new sensor.Session({ preset: "chrome-latest" });
  ...
  const session4 = new sensor.Session({ preset: "chrome-latest" });
